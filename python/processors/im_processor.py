    ...
    def process(self, msg):
        ...
        if mentioned_users:
            if mentioned_users[0] == self.bot_id and commands[0] == 'clear':
                ...
                self.bot_client.get_message_client().send_msg(msg['stream']['streamId'], render_expense_approval_from_message(userId, 'python/listeners/expense_approval_form/html/create_expense_approval_form.html'))
